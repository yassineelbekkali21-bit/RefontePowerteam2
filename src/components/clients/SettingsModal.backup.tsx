            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center space-x-3">
                  <input
                    type="checkbox"
                    checked={settings.tarifPreferentiel}
                    onChange={(e) => setSettings({...settings, tarifPreferentiel: e.target.checked})}
                    className="rounded"
                  />
                ...
                <div>
                  ...
                  <input
                    type="number"
                    value={settings.remise}
                    onChange={(e) => setSettings({...settings, remise: parseFloat(e.target.value) || 0})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    min="0"
                    max="100"
                    step="0.1"
